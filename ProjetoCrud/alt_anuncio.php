...
<input type="text" class="form-control" name="id_anuncio" id="id_anuncio"

value="<?php echo $result['id']; ?>" readonly>
</div>
<div class="col-4">
<label for="fase">Fase</label>
<select class="form-select" name="fase" id="fase">
<option>Selecione a fase do animal</option>
<option value="F" <?php echo $result['fase'] == 'F' ? "selected" : ""

?>>Filhote</option>

<option value="A" <?php echo $result['fase'] == 'A' ? "selected" : ""
...
<option value="P" <?php echo $result['porte'] == 'P' ? "selected" : ""

?>>Pequeno</option>

<option value="M" <?php echo $result['porte'] == 'M' ? "selected" : ""

?>>Médio</option>

<option value="G" <?php echo $result['porte'] == 'G' ? "selected" : ""
...
<textarea name="observacao" class="form-control" id="observacao" rows="3"><?php

echo $result['observacao']; ?></textarea>
</div>
<br />
<button type="submit" name="enviarDados" class="btn btn-primary"
value="ALT">Alterar</button>
